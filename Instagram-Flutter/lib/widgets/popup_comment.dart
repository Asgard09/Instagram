  ...
  Future<void> _loadComments() async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse('http://192.168.1.6:8080/api/comments/post/${widget.postId}'),
        headers: {
                  ...
                  child: _comments.isEmpty
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return CommentTile(
                        ...
                        serverBaseUrl: 'http://192.168.1.6:8080', // Pass base URL
                      );
                    },
                  ),
                ),
                  ...
                  child: Row(
                    ...
                    children: [
                      widget.currentUserAvatar != null
                          ? _buildAvatar(widget.currentUserAvatar!, 'http://192.168.1.6:8080')
                          : const CircleAvatar(
                        radius: 18,
